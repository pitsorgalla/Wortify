-- import fauu/elm-selectable-text war nicht möglich
-- siehe https://github.com/fauu/elm-selectable-text/tree/2.0.1
        ...
        Just (initialNo, _, _) as currentSelection ->
          ...
          in
            if (allowInterparagraphSelection || not goesOutsideParagraph)
              ...
              then
                Just (initialNo, first tentativeRange, second tentativeRange)
              else
                currentSelection
        Nothing ->
